<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="DSNV.aspx.cs" Inherits="Ot_thi2.DSNV" %>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="eid" DataSourceID="SqlDataSource1">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Anh">
                <ItemTemplate>
                    <asp:Image ID="image" runat="server" ImageUrl='<%# Eval("image") %>'  Width="120px" />
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="eid" DataNavigateUrlFormatString="Edit.aspx?eid={0}" HeaderText="Edit" Text="Edit" />
        </Columns>
    </asp:GridView>
