<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ThemSV.aspx.cs" Inherits="OntapTMDT.ThemSV" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="NoiDung" runat="server">
    ...
    <InsertItemTemplate>
        ...
        <br />
        Mã lớp:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource1" DataTextField="tenlop" DataValueField="malop" 
