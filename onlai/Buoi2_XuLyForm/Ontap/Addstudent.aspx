<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Addstudent.aspx.cs" Inherits="Ontap.Addstudent" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:FormView ID="FormView1" DefaultMode="Insert" runat="server" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="masv" DataSourceID="SqlDataSource1" GridLines="Both">
                ...
                <InsertItemTemplate>
                    ...
                    <br />
                    Mã lóp :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource2" DataTextField="tenlop" 
                        DataValueField="malop">
                    </asp:DropDownList>
        ...
        <a href="ListStudent.aspx">Xem danh sách sv</a>
    </form>
</body>
</html>
