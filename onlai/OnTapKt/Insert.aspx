<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Insert.aspx.cs" Inherits="OnTapKt.Xoasv" %>
<asp:Content ID="Content1" ContentPlaceHolderID="tieude" runat="server">
    Xóa sinh viên
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="noidung" runat="server">
    <asp:FormView ID="FormView1" DefaultMode="Insert" DataKeyNames="masv" runat="server" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="masv" DataSourceID="SqlDataSource1" GridLines="Both" OnItemInserting="InsertingEvent">
        <EditItemTemplate>
            masv:
    ...
    <a href="DanhsachSV.aspx">Xem sanh sach</a>
</asp:Content>
