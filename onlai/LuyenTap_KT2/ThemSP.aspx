<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ThemSP.aspx.cs" Inherits="LuyenTap_KT2.ThemSP" %>
<asp:Content ID="Content1" ContentPlaceHolderID="NoiDung" runat="server">
   
        <asp:FormView ID="FormView1" runat="server" DefaultMode="Insert" DataKeyNames="Pid" DataSourceID="SqlDataSource1" OnItemInserting="FormView1_ItemInserting" OnItemInserted="FormView1_ItemInserted">
            <EditItemTemplate>
                Pid:
...
<%--     <asp:Label ID="errorMsg" ForeColor="Red" runat="server"></asp:Label><br />--%>
    <a href="DSSP.aspx">Xem sanh sach sp</a>
</asp:Content>
