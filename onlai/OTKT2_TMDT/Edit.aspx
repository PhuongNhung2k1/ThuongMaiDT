<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="OTKT2_TMDT.Edit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="NoiDung" runat="server">
    <asp:FormView ID="FormView1" runat="server" DataKeyNames="Pid" DefaultMode="Edit" DataSourceID="SqlDataSource1" OnItemInserting="FormView1_ItemInserting">
        <EditItemTemplate>
            Pid:
