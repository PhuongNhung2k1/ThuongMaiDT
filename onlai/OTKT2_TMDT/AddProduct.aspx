<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AddProduct.aspx.cs" Inherits="OTKT2_TMDT.AddProduct" %>
<asp:Content ID="Content1" ContentPlaceHolderID="NoiDung" runat="server">
    
        <asp:FormView ID="FormView1" DefaultMode="Insert" runat="server" DataKeyNames="Pid" DataSourceID="SqlDataSource1" OnItemInserting="FormView1_ItemInserting" OnItemInserted="InsertedEvent">
            <EditItemTemplate>
                Pid:
            ...
            <InsertItemTemplate>
                Categoryid:&nbsp;
                <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource12" DataTextField="CategoryName" DataValueField="Categoryid" SelectedValue='<%# Bind("Categoryid") %>'>
                </asp:DropDownList>
                <asp:SqlDataSource ID="SqlDataSource12" runat="server" ConnectionString="<%$ ConnectionStrings:ECartDB2ConnectionString %>" DeleteCommand="DELETE FROM [Category] WHERE [Categoryid] = @Categoryid" InsertCommand="INSERT INTO [Category] ([CategoryName], [MetaTitle]) VALUES (@CategoryName, @MetaTitle)" SelectCommand="SELECT * FROM [Category]" UpdateCommand="UPDATE [Category] SET [CategoryName] = @CategoryName, [MetaTitle] = @MetaTitle WHERE [Categoryid] = @Categoryid">
                    <DeleteParameters>
    ...
    <a href="ListProduct.aspx">Xem danh sách sản phẩm</a>
</asp:Content>
