<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Listproduct2.aspx.cs" Inherits="OTKT2_TMDT.Listproduct2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="NoiDung" runat="server">
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" DataKeyNames="Pid" DataSourceID="SqlDataSource1" ForeColor="Black" GridLines="None" Height="1115px" Width="16px">
        ...
        <Columns>
            ...
            <asp:TemplateField>
               <ItemTemplate>
                    <asp:Image ID="ImagePathLabel" runat="server" ImageUrl='<%# Eval("ImagePath") %>' Width="50px" Height="60px" />
               </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:HyperLinkField  DataNavigateUrlFields="Pid" DataNavigateUrlFormatString="Edit.aspx?Pid={0}" Text="Edit" />
        </Columns>
    ...
    <a href="AddProduct.aspx">Theem san pham</a>
</asp:Content>
