<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ShoppingCart.aspx.cs" Inherits="OnThi_LL.ShoppingCart" %>
<asp:Content ID="Content1" ContentPlaceHolderID="NoiDung" runat="server">
    ...
    <%
        ...
        decimal total = 0;
        List<OnThi_LL.CartItem> li = (List<OnThi_LL.CartItem>)Session["Cart"];
        if (li != null)
        {
