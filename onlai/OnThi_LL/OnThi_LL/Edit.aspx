<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="OnThi_LL.Edit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="NoiDung" runat="server">
    <a href="Listpro.aspx">Xem danh sachs</a><br />
    <asp:FormView ID="FormView1" runat="server" DataKeyNames="Pid" DataSourceID="SqlDataSource1" DefaultMode="Edit" OnItemUpdating="FormView1_ItemUpdating1">
        <EditItemTemplate>
            Pid:
...
&nbsp;<asp:LinkButton ID="UpdateCancelButton" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel" />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT Pid , p.Categoryid, prodName, p.Metatitle, Description, ImagePath, Price from Product p, Category c where c.Categoryid = p.Categoryid and [Pid] = @Pid"
        ...
        <SelectParameters>
            <asp:QueryStringParameter Type="Int32" QueryStringField="Pid" Name="Pid" />
        </SelectParameters>
        <DeleteParameters>
