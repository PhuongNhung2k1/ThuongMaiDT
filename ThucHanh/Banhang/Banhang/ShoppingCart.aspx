<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ShoppingCart.aspx.cs" Inherits="Banhang.ShoppingCart" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="noidung" runat="server">
    ...
    <%
        ...
        decimal total = 0;
        List<Banhang.CartItem> li = (List<Banhang.CartItem>)Session["Cart"];
        if (li != null)
        {
