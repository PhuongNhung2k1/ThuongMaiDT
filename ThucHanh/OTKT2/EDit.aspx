<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="EDit.aspx.cs" Inherits="OTKT2.EDit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="NoiDung" runat="server">
    <asp:FormView ID="FormView1" runat="server" DataKeyNames="Pid" DataSourceID="SqlDataSource1" DefaultMode="Edit" OnItemUpdating="FormView1_ItemUpdating">
        <EditItemTemplate>
            ...
            <br />
            Categoryid:
            <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource1" DataTextField="ProdName" DataValueField="Categoryid" SelectedValue='<%# Bind("Categoryid") %>'>
            </asp:DropDownList>
            <br />
            ProdName:
...
&nbsp;<asp:LinkButton ID="UpdateCancelButton" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel" />
    ...
    <a href="DSSP.aspx">xem danh sach</a>
</asp:Content>
