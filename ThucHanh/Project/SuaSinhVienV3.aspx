<%@ Page Title="" Language="C#" MasterPageFile="~/Site3.Master" AutoEventWireup="true" CodeBehind="SuaSinhVienV3.aspx.cs" Inherits="Project.SuaSinhVienV3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="noidung" runat="server">
    ...
    <div>
            ...
            <asp:FormView ID="FormView1" DataKeyNames="masv" DefaultMode="Edit" runat="server" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataSourceID="SqlDataSource1" GridLines="Both" OnItemInserting="InsertingEvent">
                <EditItemTemplate>
                    Mã sinh viên:
