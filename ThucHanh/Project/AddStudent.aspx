...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:FormView ID="FormView1" DefaultMode="Insert" runat="server" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="masv" DataSourceID="SqlDataSource1" GridLines="Both" style="margin-right: 0px" Width="345px" OnItemInserting="ItemInsertingEvent">
                <EditItemTemplate>
                    Mã sinh viên:
            ...
            <a href="ListStudentByClass.aspx">Xem danh sách sinh viên </a>
        </div>
    </form>
</body>
</html>
