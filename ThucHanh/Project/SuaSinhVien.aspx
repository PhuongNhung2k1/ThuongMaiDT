<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SuaSinhVien.aspx.cs" Inherits="Project.SuaSinhVien" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:FormView ID="FormView1" DefaultMode="Edit" runat="server" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="masv" DataSourceID="SqlDataSource1" GridLines="Both">
                <EditItemTemplate>
                    Mã sinh viên:
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues"
                ...
                SelectCommand="select masv ,hoten, diachi,dienthoai, anh,s.malop , l.tenlop from sinhvien s, lophoc l where s.malop = l.malop and masv = @masv" 
        ...
        <a href="ListStudentByClass.aspx"> Xem danh sach sv</a>
    </form>
</body>
</html>
