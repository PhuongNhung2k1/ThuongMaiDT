<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="add.aspx.cs" Inherits="OTThi.add" %>
<asp:Content ID="Content1" ContentPlaceHolderID="noidung" runat="server">
    <asp:FormView ID="FormView1" DefaultMode="Insert" runat="server" DataKeyNames="Pid" DataSourceID="SqlDataSource1" OnItemInserting="FormView1_ItemInserting">
        <EditItemTemplate>
            Pid:
