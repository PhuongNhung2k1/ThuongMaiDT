<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="OTThi.Edit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="noidung" runat="server">
    <a href="listProduct.aspx">Xem danh sach</a><br />
    <asp:FormView ID="FormView1" runat="server" DefaultMode="Edit" DataKeyNames="Pid" DataSourceID="SqlDataSource1" OnItemUpdating="FormView1_ItemUpdating1">
        <EditItemTemplate>
            Pid:
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server"
        ...
        SelectCommand="SELECT Pid, p.Categoryid,ProdName,p.MetaTitle,Description, ImagePath, Price from Product p , Category c where p.Categoryid = c.Categoryid and [Pid] = @pid"
