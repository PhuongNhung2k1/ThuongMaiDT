<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ShoppingCart.aspx.cs" Inherits="Project_13_11.ShoppingCart" %>
<asp:Content ID="Content1" ContentPlaceHolderID="NoiDung" runat="server">
    ...
    <%
        ...
        decimal total = 0;
        List<Project_13_11.CartItem> li = (List<Project_13_11.CartItem>)Session["Cart"];
        if (li != null)
        {
