<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Addproduct.aspx.cs" Inherits="Project_13_11.Addproduct" %>
<asp:Content ID="Content1" ContentPlaceHolderID="NoiDung" runat="server">
   
        <asp:FormView ID="FormView1" runat="server" DefaultMode="Insert" DataKeyNames="Pid" DataSourceID="SqlDataSource1">
            <EditItemTemplate>
                Pid:
            ...
            <ItemTemplate>
                ...
                <br />
                ImagePath:
                <asp:Image ID="image" runat="server" ImageUrl='<%# "~/Images/" + Eval("ImagePath") %>' Width="80px" />    
                <br />
                Price:
