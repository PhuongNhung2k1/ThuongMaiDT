<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="OT_Thi_TMDT.Add" %>
<asp:Content ID="Content1" ContentPlaceHolderID="NoiDung" runat="server">
    <h2> Add staff</h2>
    <asp:FormView ID="FormView1" runat="server" DataKeyNames="eid" DefaultMode="Insert" DataSourceID="SqlDataSource1" OnItemInserting="FormView1_ItemInserting">
        <EditItemTemplate>
            eid:
