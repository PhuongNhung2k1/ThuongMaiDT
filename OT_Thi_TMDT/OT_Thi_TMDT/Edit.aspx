<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="OT_Thi_TMDT.Edit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="NoiDung" runat="server">
    <h2> Sửa thông tin nhân viên</h2>
    <asp:FormView ID="FormView1" runat="server" DataKeyNames="eid" DataSourceID="SqlDataSource1" DefaultMode="Edit" OnItemUpdating="FormView1_ItemUpdating1">
        <EditItemTemplate>
            eid:
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server"
        ...
        SelectCommand="SELECT eid, name, age, addr, salary,image, d.deptid, deptname from tblEmployee e , tblDept d where e.deptid = d.deptid and [eid] = @eid" 
